...
from app.api.v1.shared.auth.jwt import verify_password, create_access_token
...
class AuthService:
    ...
    async def authenticate_user(self, login_request: LoginRequest) -> Optional[TokenResponse]:
